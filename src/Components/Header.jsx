            ...
            <div className='relative'>
                <motion.img 
                    ...
                    <ul className='flex flex-col px-4 py-2'>
                        <li className='text-base text-textColor cursor-pointer hover:text-headingColor transition-all ease-in-out  duration-100 hover:bg-slate-100 px-4 py-2'>Home</li>
                        <li className='text-base text-textColor cursor-pointer hover:text-headingColor transition-all ease-in-out duration-100 hover:bg-slate-100 px-4 py-2'>Menu</li>
                        <li className='text-base text-textColor cursor-pointer hover:text-headingColor transition-all ease-in-out duration-100 hover:bg-slate-100 px-4 py-2'>About Us</li>
                        <li className='text-base text-textColor cursor-pointer hover:text-headingColor transition-all ease-in-out duration-100 hover:bg-slate-100 px-4 py-2'>Services</li>
                    </ul>
